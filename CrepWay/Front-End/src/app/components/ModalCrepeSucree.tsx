...
const Fruits = [
  { id: 27, name: 'Banane', price: 1.0, image: 'banane.png', category: 'Fruits' },
  { id: 28, name: 'Fraise', price: 1.0, image: 'fraise.png', category: 'Fruits' },
  { id: 29, name: 'Poire', price: 1.0, image: 'poire.png', category: 'Fruits' }
]
...
const ModalCrepeSucree = ({ isOpen, onRequestClose, user }: any) => {
    ...
    <Modal isOpen={isOpen} onRequestClose={onRequestClose} overlayClassName={styles.overlay} className={styles.modal}>
      <div className={styles.modalContent}>
        <div className={styles.modalHeader}>
          <h1 className={styles.modalHeaderText}>Compose ta crêpe sucrée</h1>
...
export default ModalCrepeSucree
